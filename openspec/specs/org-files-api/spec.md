...
The OCS endpoint that lists all `.org` files under the user's configured org files root directory in the authenticated user's storage, used to populate the org browser sidebar.
