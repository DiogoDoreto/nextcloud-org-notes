...
The sidebar footer SHALL render a full-width button labelled "Org Notes settings" (with a cog icon) that links to the Nextcloud personal settings page for the app.

The button SHALL span the full footer width.
