...
Defines the loading and empty states shown in the org files sidebar, covering the loading indicator during fetch and contextual messages when no files are available.
